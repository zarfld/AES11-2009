...
- Requirements traceability matrix is generated by CI and committed on default branch updates:
  - See reports/traceability-matrix.md
  - Raw trace JSON: build/traceability.json (CI artifact)
  - Spec index: build/spec-index.json (CI artifact)
